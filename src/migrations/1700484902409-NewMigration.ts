...
export class NewMigration1700484902409 implements MigrationInterface {
    name = 'NewMigration1700484902409'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "region" ("id" SERIAL NOT NULL, "createdBy" character varying, "createdDate" TIMESTAMP DEFAULT now(), "lastModifiedBy" character varying, "lastModifiedDate" TIMESTAMP DEFAULT now(), "regionName" character varying NOT NULL, CONSTRAINT "PK_5f48ffc3af96bc486f5f3f3a6da" PRIMARY KEY ("id"))`);
